...
def activate_deployment(api, deployment_name, activate):
    ...
    api_response = api.patch_namespaced_deployment(
        ...
        namespace="default",
        body=deployment)
    logging.info("Deployment updated. status='%s'" % str(api_response.status))


def main():

    while True:
        logging.info("Loop: " + str(datetime.datetime.today()))
        ...
        logging.info("cpuFailureRate: " + str(cpuFailureRate))
        ...
        if NoFailureRate:
            logging.info("activating Scalability a and Fidelity a...")
            ...
            logging.info("activating Scalability b and Fidelity a...")
            ...
            logging.info("activating Scalability b and Fidelity b...")
